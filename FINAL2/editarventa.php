...
if (isset($_POST["fecha"])) {
    ...
    $query = "UPDATE ventas SET id_cliente='$id_cliente', fecha='$fecha', total='$total'  WHERE id='$id'";
...
<div class="container">
    <form method="POST" class="row g-3 needs-validation" novalidate>
        <div class="col-md-12">
            ...
            <input name="id_cliente" type="text" class="form-control" id="validationCustom01" required>
        ...
        <div class="col-md-12">
            ...
            <input name="fecha" type="date" class="form-control" id="validationCustom02" required>
            <div class="valid-feedback">
                Looks good!
            </div>
        </div>
        <div class="col-md-12">
            ...
            <input name="total" type="text" class="form-control" id="validationCustom03" required>
            <div class="valid-feedback">
                Looks good!
            </div>
        </div>
