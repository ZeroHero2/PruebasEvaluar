<?php
    ...
    $query = "SELECT id, id_compra, id_producto,cantidad, precio FROM detalle_compras ORDER BY id";
    ...
    if (isset($_POST['download_pdf'])) {
        ...
        $pdf->Ln(10);
        $pdf->SetFont('Arial', 'B', 12);
        $pdf->Cell(40, 10, 'Id compra: ', 0);
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(60, 10, $id_compra, 0, 1);
        ...
        $pdf->Output('D', 'detalle de compra.pdf');
        exit();
}
?>
...
<body>
    <center>
        ...
        <br>
        <a class="btn btn-primary" href="agregardc.php" role="button">Agregar detalle de compra</a>
    </center>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" style="display:inline;">
                                        ...
                                        <input type="hidden" name="id_compra" value="<?php echo $datos[$i][1]; ?>">
                                    ...
                                    <a class="btn btn-danger" href="eliminardc.php?id=<?php echo $datos[$i][0]; ?>" role="button">Eliminar</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
