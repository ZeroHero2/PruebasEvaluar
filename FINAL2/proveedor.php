<?php
    ...
    $query = "SELECT id, nombre, telefono, direccion FROM proveedores ORDER BY id";
...
<head>
    ...
    <style>
        ...
        table {
            ...
            border-style: solid;
            border-width: 2px;
            border-color: #ccc; /* Color de borde gris */
            text-align: center;
        }
        th, td {
            padding: 8px;
...
<body>
    <center>
        ...
        <br>
        <a class="btn btn-primary" href="agregarprov.php" role="button">Agregar Proveedor</a>
    </center>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($datos); $i++): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="editarprov.php?id=<?php echo $datos[$i][0]; ?>" role="button">Editar</a>
                                    <a class="btn btn-primary" href="eliminarprov.php?id=<?php echo $datos[$i][0]; ?>" role="button">Eliminar</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
