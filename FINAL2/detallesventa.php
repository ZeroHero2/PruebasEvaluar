...
if (isset($_POST['download_pdf'])) {
    ...
    $pdf->Cell(60, 10, $row['cliente'], 0, 1);

    $pdf->SetFont('Arial', 'B', 12);
    $pdf->Cell(40, 10, 'Vendedor: ', 0);
    $pdf->SetFont('Arial', '', 12);
    $pdf->Cell(60, 10, $row['vendedor'], 0, 1);
...
<body>
    <center>
        <a href="Ventas.php"><img src="https://i0.wp.com/tramadiseno.com.mx/wp-content/uploads/2022/08/Negro3x-1.png?fit=949%2C295&ssl=1" 
