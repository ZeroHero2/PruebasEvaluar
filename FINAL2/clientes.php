<?php
    ...
    $query = "SELECT id, nombre, telefono, direccion FROM clientes ORDER BY id";
...
<body>
    <center>
        ...
        <br>
        <a class="btn btn-primary" href="agregarcliente.php" role="button">Agregar Cliente</a>
    </center>
                    ...
                    <tbody>
                        <?php for($i = 0; $i < count($datos); $i++): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="editarcli.php?id=<?php echo $datos[$i][0]; ?>" role="button">Editar</a>
                                    <a class="btn btn-danger" href="eliminarcli.php?id=<?php echo $datos[$i][0]; ?>" role="button">Eliminar</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
