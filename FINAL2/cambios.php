<?php
    ...
    $query = "SELECT id, id_venta, id_producto, fecha, cantidad FROM cambios ORDER BY id";
...
<body>
    <center>
        ...
        <br>
        <a class="btn btn-primary" href="agregarcambio.php" role="button">Agregar Cambio</a>
    </center>
                    ...
                    <tbody>
                        <?php for($i = 0; $i < count($datos); $i++): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="editarcam.php?id=<?php echo $datos[$i][0]; ?>" role="button">Editar</a>
                                    <a class="btn btn-danger" href="eliminarcam.php?id=<?php echo $datos[$i][0]; ?>" role="button">Eliminar</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
