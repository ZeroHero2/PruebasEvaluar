...
<body>
    <center>
        ...
        <br>
        <a class="btn btn-primary" href="agregarorden.php" role="button">Agregar venta</a>
    </center>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($datos); $i++): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="detallesventa.php?id=<?php echo $datos[$i][0]; ?>" role="button">Visualizar</a>
                                    <a class="btn btn-primary" href="editarventa.php?id=<?php echo $datos[$i][0]; ?>" role="button">Editar</a>
                                    <a class="btn btn-danger" href="eliminarventa.php?id=<?php echo $datos[$i][0]; ?>" role="button">Eliminar</a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
